    ...
    async def _rewrite(
        ...
        *,
        ...
        content = (
            ...
            "- Treat private romantic and intimacy-bound details as sensitive "
            "even when they are not identifying by name. In strict_content, replace sensitive "
            "details with generic sensitive placeholders. In readable_content, preserve only the safe "
            "high-level meaning needed for conversation flow.\n"
