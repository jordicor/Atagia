...
#
# Vendored from https://github.com/jordicor/ai-json-cleanroom.
# Original package: ai-json-cleanroom 1.1.0, MIT License.
# See AI_JSON_CLEANROOM_LICENSE.txt in this package directory.
